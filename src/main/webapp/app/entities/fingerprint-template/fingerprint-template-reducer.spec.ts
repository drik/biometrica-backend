...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './fingerprint-template.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINGERPRINTTEMPLATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FINGERPRINTTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FINGERPRINTTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FINGERPRINTTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FINGERPRINTTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FINGERPRINTTEMPLATE actions', async () => {
      const expectedActions = [
        {
