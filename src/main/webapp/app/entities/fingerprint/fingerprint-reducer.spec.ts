...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINGERPRINT_LIST actions', async () => {
    ...
    it('dispatches FETCH_FINGERPRINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FINGERPRINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FINGERPRINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FINGERPRINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FINGERPRINT actions', async () => {
      const expectedActions = [
        {
