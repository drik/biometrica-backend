...
public class CacheConfiguration {
    ...
    public InfinispanGlobalConfigurer globalConfiguration(JHipsterProperties jHipsterProperties) {
        ...
        return () ->
            GlobalConfigurationBuilder
                ...
                .clusterName("infinispan-Biometrica-cluster")
                .jmx()
    ...
    public InfinispanCacheConfigurer cacheConfigurer(JHipsterProperties jHipsterProperties) {
        ...
        return manager -> {
            ...
            Stream
                .of(
                    com.zelix.biometrica.repository.UserRepository.USERS_BY_LOGIN_CACHE,
                    com.zelix.biometrica.repository.UserRepository.USERS_BY_EMAIL_CACHE
                )
                .forEach(cacheName ->
                    manager.defineConfiguration(
                        cacheName,
